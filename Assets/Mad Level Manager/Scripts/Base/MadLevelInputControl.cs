...
public class MadLevelInputControl : MonoBehaviour {
    ...
    #region Fields
		...
		public string axisHorizontal = "Rotation";
		public string axisVertical = "Tilt";
		public string axisEnter = "Depth";
		
		public TraverseRule traverseRule = new SimpleTraverseRule();
		...
		private bool isLeft {
			get {
				...
				case InputMode.InputAxes:
					return pxsLeapInput.GetHandAxisStep(axisHorizontal) < 0;
				default:
		...
		private bool isDown {
			get {
				...
				case InputMode.InputAxes:
					return pxsLeapInput.GetHandAxisStep(axisVertical) < 0;
				default:
					Debug.LogError("Unknown input mode: " + inputMode);
					return false;
				}
		...
		private bool isEnter {
			get {
				...
				case InputMode.InputAxes:
					return pxsLeapInput.GetHandAxis(axisEnter) > 0;
				default:
					Debug.LogError("Unknown input mode: " + inputMode);
					return false;
				}
		...
		void Update() {
			...
			if ((isLeft || isRight || isUp || isDown) && activeIcon == null) {
				...
				if (newIcon != null && newIcon != activeIcon) {
					Activate(newIcon);
				}
			}
