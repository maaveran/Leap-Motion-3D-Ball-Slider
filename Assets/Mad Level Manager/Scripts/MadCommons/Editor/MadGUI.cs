...
#region ScrollableList
    public class ScrollableList<T> where T : ScrollableListItem {
        ...
        public event Action<List<T>> selectionCallback;

        public HashSet<System.Type> acceptDropTypes = new HashSet<System.Type>();

        public event Action<int, Object> dropCallback;
            ...
            set { 
                ...
                if (value != null) {
                    ...
                    if (selectionCallback != null) {
                        selectionCallback(_selectedItems);
                    }
                }
            }
        }
...
#region ArrayList
    ...
    public class ArrayList<T> where T : class {
        ...
        public bool drawRemoveButton = true;
        
        public RunnableGeneric0<T> createFunctionGeneric = () => {
...
#region Wrappers
    ...
    public static DirtyCheckC DirtyCheck(Object obj) {
        return new DirtyCheckC(obj);
    }
...
#region Properties
    ...
    public class EnableC : System.IDisposable {
        ...
        public EnableC(bool condition) {
            ...
            GUI.enabled = previousState && condition;
        }
    ...
    public class DirtyCheckC : System.IDisposable {
        private Object obj;

        public DirtyCheckC(Object obj) {
            this.obj = obj;
            EditorGUI.BeginChangeCheck();
        }
