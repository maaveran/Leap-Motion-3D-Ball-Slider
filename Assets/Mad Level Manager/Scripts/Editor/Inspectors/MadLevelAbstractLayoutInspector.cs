...
public class MadLevelAbstractLayoutInspector : Editor {
    ...
    protected SerializedProperty enumerationOffset;
    ...
    protected SerializedProperty useCurrentlyActiveConfiguration;
    ...
    protected virtual void OnEnable() {
        ...
        enumerationOffset = serializedObject.FindProperty("enumerationOffset");
        ...
        useCurrentlyActiveConfiguration = serializedObject.FindProperty("useCurrentlyActiveConfiguration");
    }
