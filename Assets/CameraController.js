...
function LateUpdate () {																					// after character moves and animations play
	...
	x += pxsLeapInput.GetHandAxisStep("Horizontal") * xSpeed * 0.02;															// set x to axis movement horizontal
	y -= pxsLeapInput.GetHandAxisStep("Depth") * ySpeed * 0.02;															// set y to axis movement vertical
